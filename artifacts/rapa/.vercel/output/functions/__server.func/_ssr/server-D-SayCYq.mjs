import "../_runtime.mjs";
import { _ as requestHandler, a as X_TSS_RAW_RESPONSE, d as getResponse, f as getStartContext, g as mergeHeaders, h as isResolvedRedirect, i as TSS_SERVER_FUNCTION, l as flattenMiddlewares, m as isRedirect, n as TSS_CONTENT_TYPE_FRAMED_VERSIONED, o as X_TSS_SERIALIZED, p as getStartOptions, r as TSS_FORMDATA_CONTEXT, s as createNullProtoObject, t as FrameType, v as runWithStartContext, y as safeObjectMerge } from "./request-response-DE8FPPId.mjs";
...
import { t as createMiddleware } from "./createMiddleware-BZHbA8Vp.mjs";
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CSVCtihV.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CnZ9K4YS.mjs"),
		import("./start-le9y1Qb2.mjs"),
		import("./empty-plugin-adapters-BaOCVvur.mjs")
	]);
	return {
		routerEntry,
		startEntry,
