  ...
  head: () => ({
    meta: [
      ...
      { title: "Hoje — RAPPAA" },
      {
        name: "description",
        content:
          "RAPPAA é um espaço para registrar sua jornada, compreender seus ciclos e refletir com KAI, seu mentor de consciência.",
      },
      { property: "og:site_name", content: "RAPPAA" },
      ...
      { name: "twitter:title", content: "Hoje — RAPPAA" },
